...
public class PerlinNoise
{
            ...
            do {
               ...
               hi = Math.max(U, Math.max(V, W));
                    ...
                    Math.min(Math.abs(U - V),
                             Math.min(Math.abs(U - W), Math.abs(V - W)))
                    < .2);
        }
    ...
    /**
     * Generate 3D noise
     * @param x - x coordinate for projection
     * @param y - y coordinate for projection
     * @param z - z coordinate for projection (used for time)
     * @return noise value for pixel at x,y,z coordinates from -1.0 to 1.0
     */
     ...
     * @param x - x coordinate for projection
     * @param y - y coordinate for projection
     * @return noise value for graph projections
     */
    ...
    /**
     * Stub function calling {@link #init(int)}
